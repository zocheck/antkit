...
export const DateInputBox = ({
  ...
  <div
    ...
    className={cn(
      'group/date-input flex h-[38px] w-full min-w-0 items-center gap-1 rounded-md border border-input bg-transparent py-1 pr-1 pl-3 shadow-xs transition-[color,box-shadow] dark:bg-input/30',
